...
android {
    namespace = "com.sample.gamopedia.project"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.sample.gamopedia.project"
...
compose.desktop {
    application {
        mainClass = "com.sample.gamopedia.project.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.sample.gamopedia.project"
